...
분량·간결성 규칙(중요):
- 명식 세부 항목(오행 분포, 십신, 지장간, 납음, 십이운성, 12신살, 공망, 월령 등)은 "내부 분석 근거"로만 쓰고, 결과 글에 항목을 표나 목록으로 나열하지 마세요.
- 특히 오행은 각 오행(목·화·토·금·수)을 하나씩 풀어 설명하지 말고, 전체 균형에서 강한 기운과 부족한 기운의 핵심만 1~2문장으로 짧게 요약하세요.
- 용어를 나열·정의하기보다, 그것이 이 사람의 성격·삶에 어떤 의미인지 결론 위주로 간결하게 쓰세요. 불필요한 반복과 군더더기 설명을 피하세요.
